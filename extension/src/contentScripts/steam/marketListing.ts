...
const addStickers = () => {
  ...
  `,
        ...
        if (!isCommodityItem && listings.length === undefined) {
            const showStickerHolder = !csgoFloatExtPresent() ? '' : 'hidden';
            document
                    ...
                    if (
                        ...
                        if (listingRow.querySelector('.stickerHolderMarket') === null) {
                            ...
                            nameBlock.insertAdjacentHTML(
                                'beforeend',
                                DOMPurify.sanitize(
                                    `<div class="stickerHolderMarket ${showStickerHolder}" id="stickerHolder_${listingID}"></div>`,
                                ),
                            );
                        ...
                        <a href="${stickerInfo.marketURL}" target="_blank">
                            ...
                            listingRow
                                .querySelector('.stickerHolderMarket')
                                .insertAdjacentHTML(
                                    'afterend',
                                    DOMPurify.sanitize(
            ...
            ({ prices, pricingProvider, pricingMode, exchangeRate, currency }) => {
                ...
                if (listingElement !== null) {
                    ...
                    listingElement.setAttribute(
                        'data-sticker-price',
                        stickersTotalPrice === null ? '0.0' : stickersTotalPrice.price.toString(),
                    );
...
const addFloatBarSkeletons = () => {
    if (appID === steamApps.CSGO.appID) {
        chrome.storage.local.get(
            ['autoFloatMarket', 'marketShowFloatValuesOnly'],
            ({ autoFloatMarket, marketShowFloatValuesOnly }) => {
                    ...
                    if (listingsSection !== null) {
                        ...
                        if (listingNameBlocks !== null && itemWithInspectLink) {
                            listingNameBlocks.forEach((listingNameBlock) => {
                                if (
                                    listingNameBlock.getAttribute('data-floatBar-added') === null ||
                                    listingNameBlock.getAttribute('data-floatBar-added') === false
                                ) {
                                    listingNameBlock.insertAdjacentHTML(
                                        'beforeend',
                                        DOMPurify.sanitize(getFloatBarSkeleton('market')),
                                    );
                                    listingNameBlock.setAttribute('data-floatBar-added', 'true');

                                    // adds "show technical" hide and show logic
                                    listingNameBlock
                                        .querySelector('.showTechnical')
                                        .addEventListener('click', (event) => {
                                            event.target.parentNode
                                                .querySelector('.floatTechnical')
                    ...
                    listingsSection
                        ...
                        .forEach((listingRow) => {
                            if (
                                ...
                                if (listingRow.querySelector('.originalPrice') === null) {
                                    // if not added before
                ...
                listingsSection
                    ...
                    .forEach((listingRow) => {
                        if (
                            ...
                            if (listingRow.getAttribute('data-highlightseen') === null) {
...
const buyOrderInfoEl =
    isCommodityItem === true
...
if (buyOrderInfoEl !== null) {
    ...
    document.getElementById('place_highest_order').addEventListener('click', () => {
        getHighestBuyOrder(appID, fullName).then((highestOrder) => {
            createOrder(appID, fullName, parseInt(highestOrder) + 1, 1, getBuyerKYCFromPage())
                .then(() => {
...
if (isCommodityItem) {
    ...
    sellOrdersDiv.insertAdjacentHTML(
        'afterend',
        '<div id="show_more_sell" class="btn_grey_black btn_medium"><span>Show All</span></div>',
    );
        ...
        ({ marketShowBuySellNonCommodity, marketShowRecentActivityNonCommodity }) => {
            ...
            if (listingItemInfoEl !== null && myListingsEl !== null) {
                if (marketShowBuySellNonCommodity) {
                    listingItemInfoEl.insertAdjacentHTML(
                        'beforeend',
            ...
            elementToInsertTo.insertAdjacentHTML(
                ...
                <div class="realMoneySites">
                  <div class="realMoneySite">
                    ...
                    <img alt="Skinport logo" style="height: 50px" src="${chrome.runtime.getURL(
                  ...
                  <div class="realMoneySite">
                    <a href="https://csgofloat.com?ref=gerytrading" target="_blank" class="realMoneySiteLink referralLink" data-site="csgofloat">
                        <img alt="CSGOFloat logo" style="height: 50px" src="${chrome.runtime.getURL(
                  ...
                  <div class="realMoneySite">
                    <a href="https://bskn.co/?market_hash_name=${fullName}&appid=${appID}&sort_by=price&order=asc&ref_alias=xcW4c_phcUc" target="_blank" class="realMoneySiteLink referralLink" data-site="bitskins">
                        <img alt="Bitskins logo" style="height: 50px" src="${chrome.runtime.getURL(
                ...
                <div class="realMoneySites">
                 <div class="realMoneySite">
                    <a href="https://cs.money/csgo/trade/?utm_source=sponsorship&utm_medium=cstrade&utm_campaign=cstrd0920&utm_content=link#skin_name=${fullName}" target="_blank" class="realMoneySiteLink referralLink" data-site="csmoney">
                        <img alt="Csmoney logo" style="height: 50px" src="${chrome.runtime.getURL(
                  ...
                  <div class="realMoneySite">
                    <a href="https://skinbaron.com/partner/gery" target="_blank" class="realMoneySiteLink referralLink" data-site="csgofloat" data-site="skinbaron">
                        <img alt="Skinbaron logo" style="height: 50px" src="${chrome.runtime.getURL(
                  ...
                  <div class="realMoneySite">
                    <a href="https://affiliate.swap.gg/223.html" target="_blank" class="realMoneySiteLink referralLink" data-site="swapgg">
                        <img alt="Swapgg logo" src="${chrome.runtime.getURL(
                ...
                <div class="realMoneySites">
                 <div class="realMoneySite">
                    <a href="https://dmarket.com/?ref=hJEDYLBTsV" target="_blank" class="realMoneySiteLink referralLink" data-site="dmarket">
                        <img alt="Dmarket logo" style="height: 50px" src="${chrome.runtime.getURL(
                  ...
                  <div class="realMoneySite">
                    <a href="https://pricempire.com/market?name=${fullName}" target="_blank" class="realMoneySiteLink referralLink" data-site="pricempire">
                        <img alt="Pricempire logo" src="${chrome.runtime.getURL(
                            'images/external_logos/pricempire.png',
                        )}" data-site="pricempire">
                        <br>
                        Pricempire.com
                    </a>
                  </div>
                  <div class="realMoneySite">
                    <a href="https://itemherald.com/market/csgo?query=${fullName}&ref=gery" target="_blank" class="realMoneySiteLink referralLink" data-site="itemherald" data-site="skinbaron">
                        <img alt="Itemherald logo" style="height: 50px" src="${chrome.runtime.getURL(
                            'images/external_logos/itemherald.png',
                        )}" data-site="itemherald">
                        <br>
                        ItemHerald.com
                    </a>
                  </div>

const dopplerPhases = {
    ...
    sh: {
        ...
        color: '0000ff',
        element:
            '<img src="https://steamcommunity-a.akamaihd.net/economy/emoticon/bluejewel" class="gemIcon">',
    },
    rb: {
        type: 'doppler',
        name: 'Ruby',
        ...
        color: 'ff0000',
        element:
            '<img src="https://steamcommunity-a.akamaihd.net/economy/emoticon/redjewel" class="gemIcon">',
    },
    bp: {
        type: 'doppler',
        name: 'Black Pearl',
        ...
        color: '000000',
        element:
            '<img src="https://steamcommunity-a.akamaihd.net/economy/emoticon/lltqjewel" class="gemIcon">',
    },
    gp1: {
        type: 'gamma',
        name: 'Phase 1',
    ...
    em: {
        ...
        color: '00ff00',
        element:
            '<img src="https://steamcommunity-a.akamaihd.net/economy/emoticon/greenjewel" class="gemIcon">',
    },
    unk: {
        type: 'unknown',
        name: 'Unknown',

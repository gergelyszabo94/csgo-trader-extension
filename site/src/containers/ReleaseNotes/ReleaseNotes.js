...
const releaseNotes = (props) => {
    ...
    return  (
      <Fragment>
          ...
          <Container className='buildingBlock' id='2.4'>
              ...
              <div className='video-container'>
                  <iframe
                    width='560'
                    height='315'
                    src='https://www.youtube.com/embed/KnEHfG8W2kE'
                    frameBorder='0'
                    allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture'
                    title='CSGO Trader Updated 2.4 Release Notes'
                    allowFullScreen>
                  </iframe>
              </div>
              < br />
          ...
          <Container className='buildingBlock' id='2.3'>
              <h2>2.3 - Mass selling, trading, friend requests improvements and more</h2>
              <p>
                  It's been almost a month since the last update so as you can imagine I have a lot of new things to show you!
                  If you prefer the video format where I go into even more detail I have you covered:
              </p>
              <div className='video-container'>
                  <iframe
                    width='560'
                    height='315'
                    src='https://www.youtube.com/embed/kgWkpjm4uhs'
                    frameBorder='0'
                    allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture'
                    title='CSGO Trader Updated 2.3 Release Notes'
                    allowFullScreen>
                  </iframe>
              </div>
              < br />

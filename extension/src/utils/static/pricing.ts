...
export const pricingProviders = {
    csgotrader: {
        ...
        description:
            "The extension's own pricing, aims to be accurate and to provide some kind of price for every item.",
        pricing_modes: {
            csgotrader: {
    ...
    bitskins: {
        ...
        description:
            'BITSKINS is a "real money" marketplace where you can buy and sell skins. They provide sales data through their API.',
        pricing_modes: {
            bitskins: {
    ...
    csmoney: {
        ...
        url: 'https://cs.money/',
        description:
            "CS.MONEY is a tradebot site that has it's own pricing. They also have different prices for each doppler phase.",
        pricing_modes: {
            csmoney: {
    ...
    csgotm: {
        ...
        description:
            "CSGO.TM or market.csgo.com is a Russian site for real money sales. They also provide pricing, but prices are missing for many items so I don't recommend using it.",
        pricing_modes: {
            csgotm: {
    ...
    lootfarm: {
        ...
        url: 'https://loot.farm/',
        description:
            'LOOT.FARM is a tradebot site with public pricing, they tend to overvalue everything in general, so their prices differ from the others.',
        pricing_modes: {
            lootfarm: {
...
export const realTimePricingModes = {
    bid_price: {
        ...
        description:
            'Bid price - The value of the current highest buy order / bid for the item, also known as instant sell',
    },
    mid_price: {
        key: 'mid_price',
    ...
    ask_price: {
        ...
        description:
            'The asking price, the price of the current lowest listing for the item, also known as the starting at price',
    },
};

    ...
    return (
        <Category title='General'>
            <Row
                ...
                description={
                    <>
                        Automatically generates and adds the Steam API key to the extension when
                        visiting&nbsp;
            ...
            <Row
                ...
                description={
                    <>
                        ...
                        . It - for example - allows the extension to open a tab and put it in focus,
                        allows notifications to be clickable, opens the bookmarks page when an item
                        is bookmarked, etc. I am using it in this mode so it&apos;s also less likely
                        to be buggy as well.
                    </>
                }
                permission='tabs'
            ...
            <Row
                ...
                description={
                    <>
                        Sends anonymous usage data to the developers to help discover problems and
                        better understand how the extension is used. Check the

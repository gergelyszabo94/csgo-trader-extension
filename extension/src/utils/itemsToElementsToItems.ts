...
export const findElementByIDs = (appID, contextID, assetID, type) => {
...
// by the supplied ids
export const getItemByIDs = (items, appID, contextID, assetID) => {
...
export const getIDsFromElement = (element?: Element, type?: string) => {
